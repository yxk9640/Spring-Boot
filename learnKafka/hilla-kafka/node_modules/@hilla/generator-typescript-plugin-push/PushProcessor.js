...
class PushProcessor {
  ...
  process() {
    ...
    if (this.#operations.removeInitImport) {
      const importHillaFrontend = importStatements.find(
        (statement) => ts.isImportDeclaration(statement) && statement.moduleSpecifier.text === "@hilla/frontend"
      );
      if (importHillaFrontend) {
        const updatedImportStatement = this.#removeInitImport(importHillaFrontend);
  ...
  #removeInitImport(importStatement) {
